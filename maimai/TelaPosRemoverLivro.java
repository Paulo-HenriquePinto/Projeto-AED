...
public class TelaPosRemoverLivro {
    ...
    public void Tela() {
        ...
        JLabel mensagem = func.criarLabel(0, 200, 800, 50, null, "Livro removido com sucesso!", false, new Font("Arial", Font.BOLD, 30));
    ...
    Central controlador = new Central(); 
    
    TelaPosRemoverLivro telaSucesso = new TelaPosRemoverLivro(controlador); 
    
    telaSucesso.VerTela(true);   
    }
