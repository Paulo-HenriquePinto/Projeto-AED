...
public class addLivro {
    ...
    JTextField[] camposTexto = new JTextField[4]; // campos do livro
            ...
            if(arquivo == null || !arquivo.exists()){
                if(camposTexto[0].getText().equals("") && camposTexto[1].getText().equals("")
                    ...
                    System.out.println("Vazio");
                        ...
                        controle.biblio.add(new Livro(titulo, camposTexto[1].getText(), camposTexto[3].getText(), camposTexto[2].getText(), func.SemCapa, txtDescricao.getText(), 10));
                ...
                String titulo = camposTexto[0].getText().equals("") ? "NoName$" : camposTexto[0].getText();
                controle.biblio.add(new Livro(titulo, camposTexto[1].getText(), camposTexto[3].getText(), camposTexto[2].getText(), nomeImagemLivro, txtDescricao.getText(), 10));
                controle.VerTelaAdicionado(true);
                ResetTela();
            }
        });
