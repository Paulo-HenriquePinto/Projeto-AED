...
public class menu {
    ...
    public void Botoes(){
        JButton botaoAcervo = func.botao(50, 120, 140, 40, new Color(227,163,36), "Acervo", null, null);
        ...
        JButton botaoAdicionar = func.botao(50, 200, 140, 40, new Color(227,163,36), "Adicionar Livro", null, null);
        ...
        JButton botaoOperacoes = func.botao(50, 280, 140, 40, new Color(227,163,36), "Operações", null, null);
    ...
    public void Titulo(){
        JPanel titulo = func.criaJPanel(15, 0, 250, 80, new Color(24, 58, 89), null);//Adicionando o título
        lateralCinza.add(titulo);

        JLabel textoTitulo = func.criarLabel(20, 15, 210, 40, null, "Menu Principal", false, new Font("Arial", Font.BOLD, 24));
